...
function renderColumn(cards: Card[], suit: 'wrench' = 'wrench') {
...
describe('SuitColumn', () => {
  ...
  it('renders card content in occupied slots', () => {
    const cards: Card[] = [
      { id: 'w1', suit: 'wrench', value: 1, name: 'Pipe Wrench', description: 'Turns pipe' },
    ]
    renderColumn(cards, 'wrench')
    expect(screen.getByText('Pipe Wrench')).toBeDefined()
  })

  it('occupied slots are draggable, empty slots are not', () => {
    const cards: Card[] = [
      { id: 'w1', suit: 'wrench', value: 1, name: 'Test Card', description: '' },
    ]
    renderColumn(cards, 'wrench')
  ...
  it('filters cards to only show the given suit', () => {
    const cards: Card[] = [
      { id: 'w1', suit: 'wrench', value: 1, name: 'Wrench Card', description: '' },
      { id: 'h1', suit: 'hammer', value: 1, name: 'Hammer Card', description: '' },
    ]
    renderColumn(cards, 'wrench')
